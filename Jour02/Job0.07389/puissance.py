class Board:
    ...
    def play(self, column, color):
        if color not in ["r", "j"]:
            print("The player is neither red nor yellow")
        else:
    ...
    def run(self):
        color_one = input("color player 1: r for 'red' and y for 'yellow'")
        if color_one not in ["r","y"]:
            print("bad color input, type r for red and y for jaune")
        else:
            color_two = "y" if color_one == "r" else "r"
